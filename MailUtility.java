...
public class MailUtility {
    ...
    public static void sendEmail(String to,File f) {
        long start, end;
        ...
        try {
            ...
            param.put("to",to);
            param.put("from", AndroidConstants.EMAIL_FROM_NAME);
            param.put("subject", "Captured Photo ");
            param.put("body", "Please check the attached photo of intruder.");
            param.put("user", AndroidConstants.EMAIL_ID);
            MimeBodyPart mbp2 = new MimeBodyPart();
//            File mediaStorageDir = new File(AndroidConstants.SDCARD_FOLDER);
...
//        sessio1n.setDebug(true);
    ...
    public boolean sendEmailMultipart(HashMap parameters) {
        ...
        if (fromTitle.length() == 0) {
            fromTitle = AndroidConstants.EMAIL_FROM_NAME;
        }
